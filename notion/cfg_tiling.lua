...
defbindings("WTiling", {
    ...
    kpress(META.."H", "WTiling.split_at(_, _sub, 'right', true)"),

    bdoc("Split current frame vertically.", "vsplit"),
    kpress(ALTMETA.."H", "WTiling.split_at(_, _sub, 'bottom', true)"),

    bdoc("Destroy current frame.", "unsplit"),
    kpress(META.."Z", "WTiling.unsplit_at(_, _sub)"),

    bdoc("Go to frame below current frame.", "vframe"),
    kpress(META.."S", "ioncore.goto_next(_sub, 'down', {no_ascend=_})"),
    bdoc("Go to frame above current frame.", "^frame"),
    kpress(META.."W", "ioncore.goto_next(_sub, 'up', {no_ascend=_})"),
    bdoc("Go to frame lest of current frame.", "<-frame"),
    kpress(META.."A", "ioncore.goto_next(_sub, 'left', {no_ascend=_})"),
    bdoc("Go to frame right of current frame.", "->frame"),
    kpress(META.."D", "ioncore.goto_next(_sub, 'right', {no_ascend=_})"),
